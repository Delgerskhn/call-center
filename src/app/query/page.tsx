          ...
          <TabsContent value="inbox">
            <div className="grid gap-4">
              <Card className="border-2 border-muted/20 p-4">
                ...
                <div className="mt-2">
                  <p className="text-sm">
                    10 хоног толгой өвдлөө, толгойны эм уугаад ч зүгээр болохгүй
                    байна, ямар эмнэлэгт үзүүлэх хэрэгтэй вэ?
                  </p>
                </div>
              ...
              <Card className="border-2 border-muted/20 p-4">
                ...
                <div className="mt-2">
                  <p className="text-sm">
                    Хэвлий хэсгээр хүчтэй, гэнэтийн өвдөлтийн шалтгаан юу байж
                    болох вэ, би хэзээ яаралтай тусламж авах ёстой вэ?
                  </p>
                </div>
                <div className="mt-4 flex items-center justify-end gap-2">
                  <Button variant="outline" size="sm">
              ...
              <Card className="border-2 border-muted/20 p-4">
                ...
                <div className="mt-2">
                  <p className="text-sm">
                    Би ойрд ядаргаанд ороод байгаа, витамины дутагдал эсвэл илүү
                    ноцтой зүйлээс болсон эсэхийг яаж тодорхойлох вэ?
                  </p>
                </div>
                <div className="mt-4 flex items-center justify-end gap-2">
                  <Button variant="outline" size="sm">
          ...
          <TabsContent value="archived">
            <div className="grid gap-4">
              <Card className="border-2 border-muted/20 p-4">
                ...
                <div className="mt-2">
                  <p className="text-sm">
                    Нуруу байнга өвдөөд байна, аль эмнэлэгт хандах вэ?
                  </p>
                </div>
                <div className="mt-4 flex items-center justify-end gap-2">
                  <Button variant="outline" size="sm">
          ...
          <TabsContent value="closed">
            <div className="grid gap-4">
              <Card className="border-2 border-muted/20 p-4">
                ...
                <div className="mt-2">
                  <p className="text-sm">
                    Байнгын батгатай тэмцэхэд хамгийн сайн арьс арчилгааны горим
                    эсвэл бүтээгдэхүүн юу вэ?
                  </p>
                </div>
                <div className="mt-4 flex items-center justify-end gap-2">
                  <Button variant="outline" size="sm">
              ...
              <Card className="border-2 border-muted/20 p-4">
                ...
                <div className="mt-2">
                  <p className="text-sm">
                    Миний арьсанд маш олон тууралт гараад загатнаад бол би яах
                    ёстой вэ?
                  </p>
                </div>
                <div className="mt-4 flex items-center justify-end gap-2">
