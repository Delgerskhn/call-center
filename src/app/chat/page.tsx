  ...
  return (
    <div className="flex flex-col h-screen bg-background">
        ...
        <div className="flex items-start gap-3 justify-end">
          <div className="bg-primary rounded-lg p-3 max-w-[70%] text-primary-foreground">
            <p>
              ...
              choppy water - the air pockets can make the plane feel like it's
              bouncing or shaking a bit. It's completely normal and usually not
              dangerous at all.
            </p>
          </div>
        </div>
      ...
      <div className="bg-card p-4 flex gap-2">
        ...
        <Button
          type="submit"
          className="rounded-lg px-4 bg-primary text-primary-foreground"
        >
          Send
        </Button>
      </div>
